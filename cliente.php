...
<html>
    ...
    <body class="bodyimagen5">
        ...
        <section>
            ...
            <div class="container-fluid" style="padding-top: 55px; margin-bottom: 55px;" >
              <div  class="row" >
          ...
          <div class="container-fluid" id="Cajacafe2">
            <div  class="row">
                ...
                <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12" style="padding-top: 40px;">
                    <h1 class="h1"> 
                        Atención al cliente
                      </h1>
                      <p class="texto" style="text-align: center;">Para resolver culquiera de sus dudas puede comunicarse con alguno de nuestros ejecutivos comerciales, ellos resolveran tus dudas, recuerda verificar antes de contactarlos.</p>
                </div>
          ...
          <div class="container">
            <div class="row"> 
                <div class="col-lg-4">        
                    <div class="card card1" >           
                        <div class="card-body card-body1">
                          <h3 class="card-title" style="text-align: center;">Luis Velásquez</h3>
                          <p class="card-text1">KAM clientes industriales<br> 
                            Teléfono: +56961930715<br>
                            Mail: luis.velasquez@laestampa.com<br>
                            </p>
                            <a href="tel:+56961930715" class="btn btn boton">Contactar</a>
                      </div>
                    </div>          
                </div>
                ...
                <div class="col-lg-4">        
                  <div class="card card1" >            
                      <div class="card-body card-body1">
                        <h3 class="card-title" style="text-align: center;">Nicolás Correa</h3>
                          <p class="card-text1">Ejecutivo venta Santiago<br>
                            Teléfono: +56989031832<br>
                            Mail: nicolas.correa@laestampa.com<br>
                            </p>
                            <a href="tel:+56989031832" class="btn btn boton">Contactar</a>
                      </div>
                   </div>          
                 </div>
              ...
              <div class="col-lg-4">        
                  <div class="card card1">         
                      <div class="card-body card-body1">
                        <h3 class="card-title" style="text-align: center;">Gabriel Soto</h3>
                          <p class="card-text1">Ejecutivo venta Santiago<br>
                            Teléfono: +56989031796<br>
                            Mail: gabriel.soto@laestampa.com<br>
                             </p>
                            <a href="tel:+56989031796" class="btn btn boton">Contactar</a>
                      </div>
                   </div>          
                 </div>
              </div>
          ...
          <div class="container">
            <div class="row"> 
                <div class="col-lg-4">        
                    <div class="card card1" >           
                        <div class="card-body card-body1">
                          <h3 class="card-title" style="text-align: center;">Jeannie Olsen</h3>
                          <p class="card-text1">Ejecutivo venta 5ta región<br>
                            Teléfono: +56993230716<br>
                            Mail: jeannie.olsen@laestampa.com<br>
                            </p>
                            <a href="tel:+56993230716" class="btn btn boton">Contactar</a>
                      </div>
                    </div>          
                </div>
                ...
                <div class="col-lg-4">        
                  <div class="card card1" >            
                      <div class="card-body card-body1">
                        <h3 class="card-title" style="text-align: center;">Daniela Velásquez</h3>
                          <p class="card-text1">Ejecutivo venta 5ta región<br>
                            Teléfono: +56934271931<br>
                            Mail: daniela.velasquez@laestampa.com<br>
                             </p>
                            <a href="tel:+56934271931" class="btn btn boton">Contactar</a>
                      </div>
                   </div>          
                 </div>
                 <div class="col-lg-4">        
                  <div class="card card1" >            
                      <div class="card-body card-body1">
                        <h3 class="card-title" style="text-align: center;">Fabiola Reyes</h3>
                          <p class="card-text1">Asesor Tecnico<br>
                            Telefono: +56989031809<br>
                            Mail: fabiola.reyes@laestampa.com<br>
                             </p>
                            <a href="tel:+56989031809" class="btn btn boton">Contactar</a>
                      </div>
                   </div>          
                 </div>
              </div>
